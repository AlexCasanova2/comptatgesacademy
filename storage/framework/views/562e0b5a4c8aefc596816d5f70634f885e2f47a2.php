...
<html lang="en">
	<head>
		...
		<title>FCB Comptatges</title>

		<!-- Bootstrap -->
		<link rel="icon" type="image/x-icon" href="<?php echo e(url('')); ?>/packages/images/favicon.png"/>
		...
		<link href="<?php echo e(url('')); ?>/packages/css/login.css" rel="stylesheet">
